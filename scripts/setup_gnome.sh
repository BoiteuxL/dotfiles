...
gsettings set org.gnome.shell favorite-apps "['org.gnome.Nautilus.desktop', 'firefox.desktop', 'org.gnome.Ptyxis.desktop', 'obsidian.desktop', 'code.desktop', 'teams-for-linux.desktop', 'org.gnome.Settings.desktop']"
